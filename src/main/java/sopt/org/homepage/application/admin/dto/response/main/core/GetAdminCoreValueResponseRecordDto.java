package sopt.org.homepage.application.admin.dto.response.main.core;
...
@Builder
public record GetAdminCoreValueResponseRecordDto(
        ...
        @Schema(description = "핵심 가치 세부 설명", example = "새로운 도전을 위해 과감히 용기내는 사람", requiredMode = Schema.RequiredMode.REQUIRED) String detailDescription,
