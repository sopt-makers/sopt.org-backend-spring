package sopt.org.homepage.application.admin.dto.response.main.member;
...
public record GetAdminMemberResponseRecordDto(
        ...
        @Schema(description = "소속", example = "경기대학교") String affiliation,
        @Schema(description = "대표 프로젝트", example = "SOPT APP") String project,
