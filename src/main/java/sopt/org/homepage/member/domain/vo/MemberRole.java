...
public enum MemberRole {
    ...
    VICE_PRESIDENT("부회장"),
    GENERAL_AFFAIRS("총무"),
    OPERATION_TEAM_LEADER("운영팀장"),
    MEDIA_TEAM_LEADER("미디어팀장"),
    PLANNING_TEAM_LEADER("기획팀장"),
    DESIGN_TEAM_LEADER("디자인팀장"),
    ...
    public static MemberRole fromLegacyRole(String role) {
        ...
        return switch (role) {
            ...
            case "운영팀장" -> OPERATION_TEAM_LEADER;
            case "미디어팀장" -> MEDIA_TEAM_LEADER;
            case "기획팀장" -> PLANNING_TEAM_LEADER;
            case "디자인팀장" -> DESIGN_TEAM_LEADER;
            case "안드로이드 파트장" -> ANDROID_LEADER;
            case "iOS 파트장" -> IOS_LEADER;
            case "웹 파트장" -> WEB_LEADER;
            case "서버 파트장" -> SERVER_LEADER;
            case "기획 파트장" -> PLAN_LEADER;
            case "디자인 파트장" -> DESIGN_LEADER;
            case "운영팀" -> OPERATION_TEAM_MEMBER;
