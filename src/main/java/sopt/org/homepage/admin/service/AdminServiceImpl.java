...
public class AdminServiceImpl implements AdminService{
    ...
    public AddMainResponseDto addMainData(AddMainRequestDto addMainRequestDto) {
        ...
        List<RecruitScheduleEntity> recruitSchedule = AddMainRecruitScheduleRequestDto.toEntityList(addMainRequestDto.getRecruitSchedule());
        ...
        List<PartIntroductionEntity> partIntroduction = AddMainPartIntroductionRequestDto.toEntityList(addMainRequestDto.getPartIntroduction());
        ...
        for (AddMainCoreValueRequestDto coreValue: addMainRequestDto.getCoreValue()) {
        ...
        List<CoreValueEntity> coreValue = AddMainCoreValueRequestDto.toEntityList(addMainRequestDto.getCoreValue(), coreValueImages);
        mainEntity.setCoreValue(coreValue);

        List<PartCurriculumEntity> partCurriculum = AddMainPartCurriculumRequestDto.toEntityList(addMainRequestDto.getPartCurriculum());
        mainEntity.setPartCurriculum(partCurriculum);

        List<String> memberProfileImages = new ArrayList<>();
        for (AddMainMemberRequestDto member: addMainRequestDto.getMember()) {
        ...
        List<MemberEntity> member = AddMainMemberRequestDto.toEntityList(addMainRequestDto.getMember(), memberProfileImages);
        ...
        List<RecruitPartCurriculumEntity> recruitPartCurriculum = AddMainRecruitPartCurriculumRequestDto.toEntityList(addMainRequestDto.getRecruitPartCurriculum());
        mainEntity.setRecruitPartCurriculum(recruitPartCurriculum);

        List<RecruitQuestionEntity> recruitQuestion = AddMainRecruitQuestionRequestDto.toEntityList(addMainRequestDto.getRecruitQuestion());
